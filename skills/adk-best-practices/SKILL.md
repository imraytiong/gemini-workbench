# ADK Best Practices Skill

This skill enforces the foundational standards for building, testing, and deploying agents within the Agentic Development Kit (ADK) workbench. Adherence to these practices ensures safety, reliability, and rapid iteration.

## Description
Provides expert guidance and strict standards for developing LLM agents, focusing on Python, sandboxing, and prompt engineering.

## <instructions>
When developing, modifying, or reviewing agentic code, you MUST adhere to the following core practices:
